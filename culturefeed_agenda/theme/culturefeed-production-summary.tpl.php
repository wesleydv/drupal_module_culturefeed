...
<div class="event-teaser">
  ...
  <div class="image">
    <?php if (!empty($thumbnail)): ?>
      <?php print culturefeed_search_detail_l('production', $cdbid, $title, '<img src="' . $thumbnail . '?width=160&height=120&crop=auto" alt="' . $title . '" />', array('attributes' => array('id' => 'cf-image_' . $cdbid), 'html' => TRUE)); ?>
    <?php endif; ?>
  </div>
